    ...
    <div>
      ...
      <div className="mt-6">
          ...
          {canSave && (
            <div className="inline-flex rounded-lg border border-slate-300 bg-white p-0.5 text-sm">
              <button
                ...
                className={`rounded-md px-3 py-1 font-medium ${!showSaved ? "bg-green-500 text-white" : "bg-[#fff] text-black hover:bg-slate-100 hover:text-black"}`}
              >
                All Alerts
              </button>
              <button
                ...
                className={`inline-flex items-center gap-1.5 rounded-md px-3 py-1 font-medium ${showSaved ? "bg-green-500 text-white" : "bg-[#fff] text-black hover:bg-slate-100 hover:text-black"}`}
              >
        ...
        {loading ? (
          ...
          <>
            <p className="mb-4 text-sm text-white dark:text-slate-400">
              Showing{" "}
