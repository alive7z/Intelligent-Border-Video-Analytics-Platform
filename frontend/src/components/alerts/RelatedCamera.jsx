  ...
  return (
    <Card>
      <div className="mb-3 flex items-center gap-2">
        ...
        <h3 className="text-sm font-semibold text-primary">Related Camera</h3>
      </div>
      <div className="flex items-center gap-3">
        <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-slate-100 text-muted">
          <VideoIcon size={20} />
        </div>
      ...
      <Link
        to={`/surveillance/${id}`}
        className="btn-focus mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-secondary hover:bg-slate-50"
      >
